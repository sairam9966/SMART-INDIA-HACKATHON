<div class="tab-pane fade" id="pills-selec-register" role="tabpanel" aria-labelledby="tab-register">
    ...
    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST" enctype="multipart/form-data" novalidate class="needs-validation">
        ...
        <!-- Name input -->
        <div class="mb-4">
            <label class="form-label" for="registerselecName" style="font-size: 1.3rem;color: black;">Name of the Selector *</label>
            <input type="text" name="selecName" id="registerselecName" pattern="^[a-zA-Z][a-zA-Z0-9-_\.\s]{5,}$" class="form-control" required />
        ...
        <!-- Email input -->
        <div class="mb-4">
            <label class="form-label" for="registerselecEmail" style="font-size: 1.3rem;color: black;">Email *</label>
            <input type="email" name="selecEmail" id="registerselecEmail" required class="form-control" required />
            <div class="invalid-feedback">
                Invalid email
            </div>
        </div>
        ...
        <!-- Phone input -->
        <div class="mb-4">
            <label class="form-label" for="registerselecPhone" style="font-size: 1.3rem;color: black;">Phone *</label>
            <input type="phone" name="selecPhone" id="registerselecPhone" pattern="[0-9]{10}" class="form-control" required />
            <div class="invalid-feedback">
        ...
        <!-- Gender input -->
        <div class="mb-4">
            <label for="selecgenders" class="form-label" style="font-size: 1.3rem;color: black;">Gender *</label>
            <div class="row" id="selecgenders">
                <div class="col-3">
                    <input class="form-check-input" value="male" type="radio" name="selecgenders" id="flexSelecRadioMale" required>
                    <label class="form-check-label" for="flexSelecRadioMale">Male</label>
                </div>
                <div class="col-3">
                    <input class="form-check-input" value="female" type="radio" name="selecgenders" id="flexSelecRadioFemale">
                    <label class="form-check-label" for="flexSelecRadioFemale">Female</label>
                </div>
                <div class="col-4">
                    <input class="form-check-input" value="others" type="radio" name="selecgenders" id="flexSelecRadioOthers">
                    <label class="form-check-label" for="flexSelecRadioOthers">Prefer Not Say</label>
                </div>
            </div>
        </div>

        <div class="mb-4">
                <label for="selecTbi" class="form-label" style="font-size: 1.3rem;color: black;">TBI Under *</label>
                <select id="selecTbi" name="selecTbi" class="form-select" required>
        ...
        <!-- Address input -->
        <div class="mb-4">
            <label for="selecAddress" class="form-label" style="font-size: 1.3rem;color: black;">Address *</label>
            <input type="text" name="selecAddress" class="form-control" id="selecAddress" placeholder="1234 Main St" required>
            <div class="invalid-feedback">
                Invalid Address
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-4">
                <label for="selecCity" class="form-label" style="font-size: 1.3rem;color: black;">City *</label>
                <input type="text" name="selecCity" class="form-control" id="selecCity" required>
                <div class="invalid-feedback">
                    City Required
                </div>
            </div>
            <div class="col-4">
                <label for="selecState" class="form-label" style="font-size: 1.3rem;color: black;">State *</label>
                <select id="selecState" name="selecState" class="form-select" required>
                    <option selected disabled value="">Choose...</option>
            ...
            <div class="col-4">
                <label for="selecZip" class="form-label" style="font-size: 1.3rem;color: black;">Zip *</label>
                <input type="text" name="selecZip" class="form-control" id="selecZip" required>
                <div class="invalid-feedback">
                    Zipcode Required
                </div>
            </div>
        ...
        <!-- Password input -->
        <div class="mb-4">
            <label class="form-label" for="registerselecPassword" style="font-size: 1.3rem;color: black;">Password *</label>
            <input type="password" name="selecPwd" id="registerselecPassword" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" class="form-control" required />
            <div class="invalid-feedback">
        ...
        <div class="mb-4">
            <label class="form-label" for="registerselecRepeatPassword" style="font-size: 1.3rem;color: black;">Repeat password *</label>
            <input type="password" name="selecPwdRep" id="registerselecRepeatPassword" class="form-control" required />
        </div>


        <!-- Submit button -->
        <button type="submit" name="selecRegister" class="btn btn-primary btn-block mb-3" style="background: linear-gradient(90deg, rgba(55,59,68,1) 0%, rgba(66,134,244,1) 100%); font-size:1.5rem;">Register</button>
...
if (isset($_POST["selecRegister"])) {

    $selecName = mysqli_real_escape_string($con, $_POST["selecName"]);
    $selecEmail = mysqli_real_escape_string($con, $_POST["selecEmail"]);
    $selecPhone = mysqli_real_escape_string($con, $_POST["selecPhone"]);
    $selecgenders = mysqli_real_escape_string($con, $_POST["selecgenders"]);
    $selecTbi = mysqli_real_escape_string($con, $_POST["selecTbi"]);
    $selecAddress = mysqli_real_escape_string($con, $_POST["selecAddress"]);
    $selecCity = mysqli_real_escape_string($con, $_POST["selecCity"]);
    $selecState = mysqli_real_escape_string($con, $_POST["selecState"]);
    $selecZip = mysqli_real_escape_string($con, $_POST["selecZip"]);
    $selecPwd = mysqli_real_escape_string($con, $_POST["selecPwd"]);
    $selecPwdRep = mysqli_real_escape_string($con, $_POST["selecPwdRep"]);


    if ($selecPwd === $selecPwdRep) {
        $selecPwdHash = password_hash($selecPwd, PASSWORD_BCRYPT);
        $emailExist = " select * from selectors where email='$selecEmail' ";
        ...
        if ($emailCount > 0) {
            ...
            $insert = " insert into selectors(name,email,phone,gender,address,city,state,zip,tbi,pwd,status) values('$selecName','$selecEmail','$selecPhone','$selecgenders','$selecAddress','$selecCity','$selecState','$selecZip','$selecTbi','$selecPwdHash','inactive') ";
