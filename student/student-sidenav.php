    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side-nav">
            ...
            <ul class="list-unstyled px-2  d-flex flex-column justify-content-center">
                <li class="mt-4 <?php if($page == 'submit-idea'){echo 'active';} ?>"><a href="submit-idea.php" class="text-decoration-none px-3 ms-4 py-2 fs-5 d-block d-flex  align-items-center"><i class="far fa-upload me-2"></i>Submit Idea</a></li>
            ...
            <ul class="list-unstyled px-2">
                <li class="mt-4"><a href="./student-logout.php" class="text-decoration-none px-3 ms-4 py-2 fs-5 d-block d-flex  align-items-center"><i class="far fa-sign-out me-2"></i>Logout</a></li>
            </ul>
        </div>
        <div class="content">
